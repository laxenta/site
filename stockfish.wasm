...
<meta name="theme-color" content="#2b6e44" />
  ...
  <link rel="stylesheet" href="/css/style.min.44ea8222ea2f014fe529b5ffe96720e854f31906af97b171c54077ca906adf35.css">
...
<body class='page page-home'>
  ...
  <div class="container">
    <div class="logo">
      <a href="/">
        <img height=36 alt="Stockfish Logo" src="/images/logo/icon_128x128@2x.png" />
        <span>Stockfish</span>
      </a>
    </div>
    <div class="logo-mobile">
      <a href="/"><img alt="Stockfish Logo" src="/images/logo/icon_128x128@2x.png" /></a>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-start">
      <div class="col-12 col-md-7 col-lg-8 col-xl-7 order-2 order-md-1">
        ...
        <li class="blog-preview">
          <span class="muted">2023-06-30</span>: <a href="/blog/2023/stockfish-16/">Stockfish 16</a>
        </li>
        </ul>
      </div>
      ...
      <div class="col-12 col-md-5 col-lg-4 col-xl-5 order-1 order-md-2 position-relative">
        <div class="image-container mb-3 mb-md-0">
          ...
          <img alt=Stockfish class="intro-image" src="/images/logo/icon_512x512@2x.png" />
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-4 mb-2">
        <div class="feature">
          ...
          <div class="feature-content">
            <p>Stockfish has won the Top Chess Engine Championship and Chess.com Computer Chess Championship, and consistently ranks highly on rating lists.</p>
          </div>
          <a href="https://en.wikipedia.org/wiki/Stockfish_%28chess%29#Competition_results" class="button">Competition Results</a>
        </div>
      </div>
      
      <div class="col-12 col-md-6 col-lg-4 mb-2">
        <div class="feature">
          <h2 class="feature-title">Open Source</h2>
          <div class="feature-content">
            <p>Stockfish is open source (GPLv3 license). That means you can read the code, modify it, and contribute back.</p>
          </div>
          <a href="https://github.com/official-stockfish/Stockfish" class="button">View Source</a>
        </div>
      </div>
      
      <div class="col-12 col-md-6 col-lg-4 mb-2">
        <div class="feature">
          <h2 class="feature-title">Run Anywhere</h2>
          <div class="feature-content">
            <p>You can use Stockfish on your computer or on your iOS or Android device. So you can get world-class chess analysis, wherever you are.</p>
          </div>
...
<div class="social">
  ...
  <script type="text/javascript" src="/js/scripts.min.93cf8be46488363ddab8d891aa6d6812bb015669c07dfccc9521c33e0eafbbf4.js"></script>
