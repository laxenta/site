<template>
    <div class="yoga-pose">
      ...
      <div class="camera-container">
        ...
        <!-- Canvas overlay for drawing the pose and keypoints -->
  ...
  export default {
    ...
    async mounted() {
      // Set the backend and wait until ready
    ...
    methods: {
      ...
      async setupCamera() {
        ...
        try {
          ...
          this.video.onloadedmetadata = () => {
            this.video.play();
            // Set the canvas size based on the video dimensions once they are available
            this.resizeCanvas();
          };
        } catch (err) {
      ...
      async detectPose() {
        // Skip detection if the video dimensions are not available yet
        ...
        // Compute joint angles for knees and elbows.
